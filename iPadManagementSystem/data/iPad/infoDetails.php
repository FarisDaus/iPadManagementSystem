<?php 
    ...
    if(isset($_SESSION['unlock_key'])){
        ...
        if(isset($_POST['serialNo_ipad'])){
            $sql_ipadInfo = "SELECT ipad.*,users.*,Accesories_ipad.* FROM ipad 
            INNER JOIN users ON ipad.ID_users = users.ID_users 
            ...
            $sql_ipadInfo3 = "SELECT ipad.*,owner.*,rental_return.*,department.*,users.* FROM rental_return 
            ...
            $dateregistered_ipad = date('d F Y', strtotime($data_ipadInfo['dateregistered_ipad']));
        }
    }
    else{
        header("Location: ../");
                ...
                <div class="row page-titles mx-0 boxShadow">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">iPad Details</a></li>
                        </ol>
                    </div>
                  </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="custom-tab-1">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#profile1">User Information</a>
                                    </li>
                                </ul>
                                                            ...
                                                            <div class="tab-content">
                                                                <div id="about-me" class="tab-pane fade active show">
                                                                    <div class="profile-personal-info">
                                                                        ...
                                                                        <div class="row mb-4">
                                                                            <div class="col-3">
                                                                                <h5 class="f-w-500">Device Name <span class="pull-right">:</span>
                                                                                </h5>
                                                                            </div>
                                                                        ...
                                                                        <div class="row mb-4">
                                                                            ...
                                                                            <div class="col-9 font-color-black"><span>01020000700<?php echo $data_ipadInfo['rfidno_ipad'] ?>0000</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row mb-4">
                                                                            <div class="col-3">
                                                                        ...
                                                                        <div class="row mb-4">
                                                                            ...
                                                                            <div class="col-9 font-color-black"><span>
                                                                                <?php if($data_ipadInfo['remarks_ipad'] == ""){
                                                                                        echo 'None';
                                                                                    } 
                                                                                    else{
                                                                                        echo $data_ipadInfo['remarks_ipad'];
                                                                                    }
                                                                                ?></span>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <span>
                                                                                    <?php 
                                                                                        if($data_ipadInfo['accesories_ipad'] == '0'){ 
                                                                                            ...
                                                                                            echo ucwords($data_ipadInfo['name_accesories']) ;
                                                                                        }
                                                                                    ?>
                                                                                </span>
                                                                            </div>
                                                                                        ...
                                                                                        <div class="tab-content">
                                                                                            <div id="about-me" class="tab-pane fade active show">
                                                                                                <div class="profile-personal-info">
                                                                                                    ...
                                                                                                    <div class="row mb-4">
                                                                                                        <div class="col-3">
                                                                                                            <h5 class="f-w-500">Staff in Charge <span class="pull-right">:</span>
                                                                                                            </h5>
                                                                                                        </div>
                                                                                                    ...
                                                                                                    <div class="row mb-4">
                                                                                                        <div class="col-3">
                                                                                                            <h5 class="f-w-500">Date Receive <span class="pull-right">:</span>
                                                                                                            </h5>
                                                                                                        </div>
                                                                                                        <div class="col-9 font-color-black"><span><?php echo $dateregistered_ipad ?></span>
                                                                                                        </div>
                                                                                                            ...
                                                                                                            <div class="row mb-4 justify-content-md-center">
                                                                                                                <div class='col-lg-12 mb-12'>
                                                                                                                    <center>
                                                                                                                        ...
                                                                                                                        <button type='button' class='btn btn-rounded btn-warning btn-download addDateDownload' id='<?php echo $data['ID_rentalReturn'] ?>' >&nbsp;&nbsp;&nbsp;&nbsp;Download&nbsp;<i class='ti ti-download color-warning'></i></button>&nbsp;
                                                                                                                        <button type='button' class='btn btn-rounded btn-info btn-download addDateView' id='<?php echo $data['ID_rentalReturn'] ?>' >&nbsp;&nbsp;&nbsp;&nbsp;View&nbsp;<i class='ti ti-eye color-warning' ></i></button><br><br><br>
