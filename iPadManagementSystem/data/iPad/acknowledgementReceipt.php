...
$inv_mst_query = "SELECT ipad.*,owner.*,rental_return.*,department.*,users.*,rental.*,Accesories_ipad.* FROM rental_return
    ...
    INNER JOIN Accesories_ipad ON ipad.ID_ipad = Accesories_ipad.ID_ipad
...
if($count>0) 
{
    ...
    if($inv_mst_data_row['box_ipad'] == '1'){
        $box = 'One (1) x Box';
    }
    else{
        $box = '';
    ...
    if($inv_mst_data_row['accesories_ipad'] == '1'){
        $casing = 'One (1) x '.ucwords($inv_mst_data_row['name_accesories']);
    }
    else{
        $casing = '';
    }
  ...
  text-justify: inter-word;
	...
	<table cellpadding="0" cellspacing="0" style="width:100%;">
        <table style="width:100%;" >
            <tr >
                <td colspan="5" align="center"><img width="120px" src="../../../system/images/pnb.png"></td>
            </tr>
            ...
            <tr>
                ...
                <td align="center" width="60px">:</td>
                <td align="left" width="250px">'.ucwords($inv_mst_data_row['name_owner']).'</td>
