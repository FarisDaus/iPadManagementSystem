<?php 
    ...
    if(isset($_SESSION['unlock_key'])){    
        ...
        $sql_users = "SELECT * FROM users WHERE dateregistered_users LIKE CONCAT(CURRENT_DATE(),'%') ";
		$query_users = mysqli_query($dbconn_ipadManagement,$sql_users);
    }
    else{
        header("Location: ../");
            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0 boxShadow">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="./adduser.php">Personal</a></li>
                      ...
                      <a href="../admin/listuser.php" class="card boxShadow">
                        <div class="stat-widget-one card-body bg-warning" >
                          ...
                          <div class="stat-content d-inline-block">
                            <div class="stat-text text-light">All Staff</div>
                    ...
                    <div class="col-lg-12">
                        <div class="card boxShadow">
                            <div class="card-header">
                                <h4 class="card-title">New Staff Registration Form</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    <label class="col-lg-12 col-form-label" for="val-usersName">Name
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-usersName" name="val-usersName" placeholder="Enter the user name..">
                                                    </div>
                                                </div>
												<div class="form-group row">
                                                    <label class="col-lg-12 col-form-label" for="val-usersEmail">Email
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-usersEmail" name="val-usersEmail" placeholder="Enter the user email..">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-sm-6 btn-submit"><center>
                                                    <button type="button" style="width:15%" class="btn btn-secondary" id="btnPreviewUser" >Next</button></center>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Today Staff Registration</h4> <a href="../admin/listuser.php" class="btn btn-primary">&nbsp;&nbsp;&nbsp;&nbsp;View All Record &nbsp;&nbsp;<i class="ti ti-angle-double-right"></i>&nbsp;&nbsp;&nbsp;</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example2" class="display" style="width:100%">
                                        ...
                                        <tbody>
											...
											?>
                                            <tr>
                                                <td><?php echo ucwords($data['name_users']) ?> <?php if($data['status_users'] == '0'){ ?><span class="badge badge-info">Normal Member</span><?php  }else if($data['status_users'] == '1'){?><span class="badge badge-info">Administrator</span><?php }else{ ?><span class="badge badge-info">Developer</span><?php }?></td>
                                                <td><?php echo $data['email_users'] ?></td>
                                                <td><?php echo $data['dateregistered_users'] ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">New Staff Registration Details</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="btnSaveUser">Confirm & Submit</button>
                    </div>
                </div>
            </div>
        </div>
