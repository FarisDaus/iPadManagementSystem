...
<head>
    ...
    <title>List Staff - iPad Management System Company Secretary Department </title>
            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0 boxShadow">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="./listuser.php">Personal</a></li>
                            <li class="breadcrumb-item"><a href="./listuser.php">List Staff</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Records of  All Staff</h4> <a href="../../system/File/iPadList.xlsx" class="btn btn-primary">&nbsp;&nbsp;&nbsp;Download &nbsp;&nbsp;<i class="ti ti-download"></i>&nbsp;&nbsp;&nbsp;</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody id="load_updateIpad">
                                            ...
                                            <tr>
                                                <td><?php echo ucwords($dataiPad['name_users']) ?> <?php if($dataiPad['status_users'] == '0'){ ?><span class="badge badge-secondary">Normal Member</span><?php  }else if($dataiPad['status_users'] == '1'){?><span class="badge badge-info">Administrator</span><?php }else{ ?><span class="badge badge-info">Developer</span><?php }?></td>
                                                <td><?php echo $dataiPad['email_users'] ?></td>
                                                <td><?php echo $dataiPad['dateregistered_users'] ?></td>
                                                <td width="15%">
                                                    <div class="row">
                                                        <div class="col-lg-2 ">
                                                        ...
                                                        <div class="col-lg-2 ">
                                                            <form action="../../form/updateIpad.php" method="POST">
                                                                <input type="hidden" name="serialNo_ipad" value="<?php echo $dataiPad['serialNo_ipad']; ?>">
                                                                <div class="tooltips">
                                                                    <span class="tooltiptexts">Change Password</span>
