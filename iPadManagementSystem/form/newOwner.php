            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card boxShadow">
                            <div class="card-header">
                                <h4 class="card-title">New User Registration Form</h4> 
                            </div>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Today User Registration</h4> <a href="../data/owner/listOwner.php?status=AllOwner" class="btn btn-primary">&nbsp;&nbsp;&nbsp;&nbsp;View All Record &nbsp;&nbsp;<i class="ti ti-angle-double-right"></i>&nbsp;&nbsp;&nbsp;</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example2" class="display" style="width:100%">
                                        ...
                                        <tbody id="load_todayOwnerReg" >
                                            <?php while($data = mysqli_fetch_array($query_today)){ 
											         $dateregistered_owner = date('d F Y', strtotime($data['dateregistered_owner']));
													$sqlDept = "SELECT * FROM department WHERE ID_dept = '".$data['ID_dept']."' ";
													$queryDept = mysqli_query($dbconn_ipadManagement, $sqlDept);
													$data_Dept = mysqli_fetch_assoc($queryDept);
											
											?>
                                            <tr>
                                                <td><?php echo ucwords($data['name_owner']) ?></td>
                                                <td><?php echo ucwords($data_Dept['name_dept']) ?></td>
                                                <td><?php echo $dateregistered_owner ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">New User Registration Details</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="saveOwner">Submit</button>
                    </div>
                </div>
            </div>
        </div>
