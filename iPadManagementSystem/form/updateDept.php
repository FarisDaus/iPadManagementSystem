<?php 
    ...
    if(isset($_SESSION['unlock_key'])){
        ...
        $sql_today = "SELECT * FROM department WHERE ID_dept = '".$_POST['IDdept']."' ";
        $query_today = mysqli_query($dbconn_ipadManagement,$sql_today);
        $data_dept = mysqli_fetch_assoc($query_today);
            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0 boxShadow">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../data/dept/listDept.php">Record</a></li>
                            <li class="breadcrumb-item"><a href="../data/dept/listDept.php">Department</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card boxShadow">
                            <div class="card-header">
                                <h4 class="card-title">Update Form - <?php echo ucwords($data_dept['name_dept']) ?></h4> 
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12" id="formOwner">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-ownerDept" name="val-ownerDept" value="<?php echo $data_dept['name_dept'] ?>" placeholder="Enter the department / division name..">
                                                        <input type="hidden" ID="IDdept" value="<?php echo $data_dept['ID_dept'] ?>">
                                                    </div>
                                                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="UpdateDept">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
