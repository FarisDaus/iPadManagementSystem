<?php 
    ...
    if(isset($_SESSION['unlock_key'])){
        ...
        $sql_today = "SELECT owner.*,department.* FROM owner INNER JOIN department ON department.ID_dept = owner.ID_dept  WHERE owner.ID_owner = '".$_POST['ownerID']."' ";
        $query_today = mysqli_query($dbconn_ipadManagement,$sql_today);
        $data_owner = mysqli_fetch_assoc($query_today);
...
<head>
    ...
    <title>New User - iPad Management System Company Secretary Department </title>
            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0 boxShadow">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../data/owner/listOwner.php?status=NewOwner">Record</a></li>
                            <li class="breadcrumb-item"><a href="../data/owner/listOwner.php?status=NewOwner">User</a></li>
                ...
                <div class="row justify-content-md-center countActive">
                    ...
                    <div class="col-lg-2 col-sm-6">
                      <a href="../data/owner/listOwner.php?status=ExistingOwner" class="card boxShadow">
                        <div class="stat-widget-one card-body countActive bg-danger">
                          <div class="stat-icon d-inline-block">
                            <i class="ti-user text-light border-light"></i>
                          </div><br>
                          <div class="stat-content d-inline-block">
                    ...
                    <div class="col-lg-12">
                        <div class="card boxShadow">
                            <div class="card-header">
                                <h4 class="card-title">Update Form - <?php echo ucwords($data_owner['name_owner']) ?></h4> 
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12" id="formOwner">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-ownerName" name="val-ownerName" placeholder="Enter the owner name.." value="<?php echo ucwords($data_owner['name_owner']) ?>">
                                                        <input type="hidden" id="IDowner" value="<?php echo ucwords($data_owner['ID_owner']) ?>">
                                                    </div>
                                                </div>
                                                <?php	if($deptAll > 0){ ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <select class="form-control val-ownerDeptSelect" id="val-ownerDeptSelect"  name="val-ownerDeptSelect">
                                                            <option value="<?php echo $data_owner['ID_dept'] ?>"><?php echo ucwords($data_owner['name_dept']) ?></option>
                                                            <?php while( $dataDept = mysqli_fetch_array($query_deptDistinct)){ ?>
																<option value="<?php echo $dataDept['ID_dept'] ?>"><?php echo ucwords($dataDept['name_dept']) ?></option>
															<?php } ?>
                                                            <option value="InputText">Others...</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row" id="myDivDept" style="display:none;">
                                                    <label class="col-lg-12 col-form-label" for="val-ownerDept">Department / Division
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control val-ownerDept2" name="val-ownerDept2" placeholder="Enter the department / division name..">
                                                    </div>
                                                </div>
												<?php }else{ ?>
												<div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control val-ownerDept" name="val-ownerDept" placeholder="Enter the department /division name..">
                                                    </div>
                                                </div>
												<?php } ?>
                                                <div class="col-lg-12 col-sm-6 btn-submit"><center>
                                                                                    <!-- Go to Function (E) -->
                                                    <button type="button" style="width:15%" class="btn btn-secondary" id="btnNextOwner" >Next</button></center>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="updateOwner">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
